...
class ResourcesTest < ApplicationSystemTestCase
  ...
  test "creating a Resource" do
    ...
    fill_in "Manager", with: @resource.manager
    fill_in "Name", with: @resource.name
    fill_in "Portfolio", with: @resource.portfolio
    fill_in "Skills", with: @resource.skills
    fill_in "Start date", with: @resource.start_date
    fill_in "Uid", with: @resource.uid
